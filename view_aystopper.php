						...
						<div id="block-sorting">
							...
							<ul id="options-list">
								...
								<li><a id="select-sort"><?php echo $sort_name; ?></a>
									<ul id="sorting-list">
										<li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-asc" >По возрастанию цены</a></li>
										<li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-desc" >По убыванию цены</a></li>
