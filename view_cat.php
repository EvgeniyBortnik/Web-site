...
if (mysql_num_rows($result) > 0)
{
    ...
    ' 
        ...
        <ul id="sorting-list">
        <li><a href="view_cat.php?'.$catlink.'type='.$type.'&sort=price-asc" >По возрастанию цены</a></li>
        <li><a href="view_cat.php?'.$catlink.'type='.$type.'&sort=price-desc" >По убыванию цены</a></li>
