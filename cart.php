<?php
    	...
    	if (isset($_POST["submitdata"]))
	{
            ...
            $_SESSION["order_phone"] = $_POST["order_address"];
			...
			<div id="block-content">
				<?php
					...
					switch($action){
						...
						{
							echo '
							<li><label for="order_fio"><span>*</span>ФИО</label><input type="text" name="order_fio" id="order_fio" value="'.$_SESSION["order_fio"].'" /><span class="order_span_style" >Пример: Шалькевич Петр Дмитриевич</span></li>
							<li><label for="order_email"><span>*</span>E-mail</label><input type="text" name="order_email" id="order_email" value="'.$_SESSION["order_email"].'" /><span class="order_span_style" >Пример: petr@gmail.com</span></li>
							<li><label for="order_phone"><span>*</span>Телефон</label><input type="text" name="order_phone" id="order_phone" value="'.$_SESSION["order_phone"].'" /><span class="order_span_style" >Пример: +375 29 165 29 43</span></li>
							<li><label class="order_label_style" for="order_address"><span>*</span>Адрес<br /> доставки</label><input type="text" name="order_address" id="order_address" value="'.$_SESSION["order_address"].'" /><span>Пример: г. Минск,<br /> ул Казинца д 4, кв 71</span></li>
							';
						}
						echo '
						<li><label class="order_label_style" for="order_note">Примечание</label><textarea name="order_note"  >'.$_SESSION["order_note"].'</textarea><span>Уточните информацию о заказе.<br />  Например: удобное время для доставки курьером<br />  (стоимость доставки по Минску: 3 рубля. <br />В пределах Минской области: 5 рублей)</span></li>
						</ul>
